...
namespace DataAccess.Abstract
{
    ...
    public interface IProductDal //product tablosunun dalını yazıyoruz yani isimlendirirken böyle şablonla isimlendiriyoruz. I da interface olduğunu gösteriyor.
    {
